...
class CountdownResetScreen extends StatefulWidget {
  const CountdownResetScreen({super.key});

  @override
  State<CountdownResetScreen> createState() => _CountdownResetScreenState();
}

class _CountdownResetScreenState extends State<CountdownResetScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Faltan ${timeCountdown.calculateDaysUntilNextWeek()} días hasta el próximo reseteo.',
